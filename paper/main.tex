...
disponíveis no repositório público associado a este
trabalho\footnote{Código-fonte, dados, \emph{notebook} de análise e este relatório:
\url{https://github.com/Anth0nYM/redes-de-computadores-dccmapi}}. No entanto, é amplamente reconhecido na literatura
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_tempo.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_throughput.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_rtt.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_perdas.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_retransmissoes.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_overhead.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_pacotes_rede.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{imgs/fase1_crossval.png}
...
\texttt{results/evidence/}. Os \emph{logs} brutos completos da bateria (60 capturas \texttt{.pcap},
registros \texttt{JSONL} da aplicação e CSVs derivados, $\approx$155~MB), por não serem versionados no
repositório, encontram-se disponíveis na nuvem para análise posterior\footnote{Pasta \texttt{logs/}
completa: \url{https://drive.google.com/drive/folders/12sBrG_SSxHayG23rZKkMgdw7EalQI_ml?usp=sharing}}.
